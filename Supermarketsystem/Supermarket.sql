...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1405626262ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=supermarket&table=sales">`supermarket`.`sales`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=supermarket&table=products">`supermarket`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=supermarket&table=categorys">`supermarket`.`categorys`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=supermarket&table=users">`supermarket`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=supermarket&table=customers">`supermarket`.`customers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=landowner&table=l_ausers">`landowner`.`l_ausers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=products">`ecommerce`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce&table=catagories">`ecommerce`.`catagories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=landowner&table=landowners">`landowner`.`landowners`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=landowner&table=users">`landowner`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="64553a45602a4c2b7a2b386c3a582772">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="supermarket" targettable="categorys">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `categorys`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="supermarket" targettable="products">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="supermarket" targettable="sales">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
